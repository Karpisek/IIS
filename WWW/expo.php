...
include_once 'shared/expoModal.php';
include_once 'shared/expoInfo.php';
include_once 'shared/search.php';
include_once "query/pushExpo.php";
        ...
        <div id="tableBox" class="col-sx-12 col-md-offset-1 col-md-10">
            ...
            <thead>
              <tr>
                ...
                <th class="col-xs-2">Název</th>
                <th class="col-xs-2">Počet zvířat</th>
                    ...
                    <td colspan="10">
                        <div class="row">
                            <div class="col-xs-offset-11 col-xs-1">
                                <button class="btn btn-success" id="plusBut" data-toggle="modal" data-target="#expoInfo">
