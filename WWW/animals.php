                    ...
                    <td colspan="5">
                        <div class="row">
                            <div class="col-xs-offset-11 col-xs-1">
                                <button class="btn btn-success" id="plusBut" data-toggle="modal" data-target="#addEmp">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content" style="height: 450px;">
          ...
          <form id="newEmpForm">
            ...
            <label>Smlouva</label>
              <div class="form-row">
                ...
                <div class="col-xs-3">
                  <input type="date" class="form-control" placeholder="Smlouva" name="smlouva">
                </div>
                <div class="col-xs-3">
                ...
                <div class="col-xs-offset-2 col-xs-4">
                    <select class="form-control">
                        <option value="volvo">Ošetřovatel</option>
                        <option value="saab">Pomocná síla</option>
                    </select>
                </div>
              </div>
                </div>
      ...
      <div class="modal-footer" style="margin-top: 120px">
          <button type="button" class="btn btn-success" data-dismiss="modal" data-toggle="modal" data-target="#setLogin" id="newEmpBut" >Save</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content" style="height: 290px;">
      ...
      <div class="modal-body" style="height: 200px;">
          <form id="setLoginForm">
              ...
              <div class="form-group"  style="margin-top: 50px">
                  ...
                  <div class="form-group-row">
                      <div class="col-xs-6">
                        <input type="password" class="form-control" placeholder="Nové heslo" name="heslo">
                      </div>
                      <div class="col-xs-6">
                        <input type="password" class="form-control form-control-warning" placeholder="Znovu pro kontrolu">
                      </div>
                  </div>
              </div>
      ...
      <div class="modal-footer">
          <button type="button" class="btn btn-success" data-dismiss="modal" id="setLoginBut">Save</button>
          <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
